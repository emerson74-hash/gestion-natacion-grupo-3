...
<div class="profile-box">
    ...
    <form
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    maxlength="15"
                    required>
                <div class="invalid-feedback">Ingrese un teléfono válido (8 a 15 números).</div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="form-text">
                    Formatos permitidos: JPG, JPEG, PNG y GIF. Tamaño máximo: 2 MB.
                </div>
            </div>

            <!-- PREVIEW -->
            
         <div class="col-12 mt-3" style="max-width: 350px;">
        ...
        <!-- BOTONES -->
        <div class="mt-4">
            <button type="submit" class="btn btn-info text-white px-4" id="save-btn">
