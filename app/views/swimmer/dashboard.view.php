...
$dayLabels = [
    ...
    'Friday'    => 'Viernes',
    'Saturday'  => 'Sábado',
    'Sunday'    => 'Domingo',   // ← antes faltaba este
];
?>
...
<div class="bg-white p-5 rounded shadow-sm">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <img
            ...
            style="width:100px;height:100px;object-fit:cover;border:3px solid #4FD1E8;"
        >

        <div>
            <h1 class="mb-1">¡Bienvenido Nadador!</h1>
            <p class="text-muted mb-0">Consultá tus inscripciones y administrá tu perfil.</p>
        </div>
        ...
        <div class="col-md-6">
            <a href="<?= _URL ?>/?url=swimmer/profile" class="text-decoration-none">
                <div class="dashboard-card-modern">
                    ...
                    <h3>Mi Perfil</h3>
                    <p>Actualizá tu teléfono, fecha de nacimiento y foto.</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-6">
            <a href="<?= _URL ?>/?url=swimmer/lessons" class="text-decoration-none">
                <div class="dashboard-card-modern">
                    ...
                    <h3>Clases</h3>
                    <p>Explorá e inscribite en las clases disponibles.</p>
                </div>
            </a>
        </div>
    ...
    <!-- TABLA MIS CLASES -->
    <h4 class="mb-3 mt-4">Mis clases inscriptas</h4>

    <?php if (empty($myBookings)): ?>

        <div class="alert alert-info">
            Todavía no estás inscripto en ninguna clase.
            <a href="<?= _URL ?>/?url=swimmer/lessons">Ver clases disponibles</a>
        </div>
...
$(document).ready(function () {
    ...
    if (!$.fn.DataTable.isDataTable(tableId)) {
        ...
        $(tableId).DataTable({
            ...
            // Sin re-orden automático: respeta el orden de día que viene del SQL
            order: []
        });
